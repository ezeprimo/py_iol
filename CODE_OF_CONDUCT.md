...
community include using an official email address, posting through an official social media
...
> **Enforcement contact: [TO BE CONFIGURED BY REPOSITORY MAINTAINERS]**
...
This Code of Conduct is adapted from the [Contributor Covenant][contributor-covenant], version
2.1.
